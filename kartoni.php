...
<body class="main-layout">
    ...
    <div class="wrapper">
        ...
        <div id="content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="ourheading">
                                <h2>Cene<strong class="white"> usluga</strong></h2>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <button class="btn btn-primary" onclick="pretraziKarton()">Prikazi karton za pacijenta</button>
                        </div>
                        <div class="col-md-12">
            ...
            <script>
                function pretraziKarton(){
                    let pacijent = $("#pacijent").val();

                    $.ajax({
                        type: 'POST',
                        url: 'vratiKartonZaPacijenta.php',
                        data: {
                            pacijent : pacijent
                        },
